...
export const register = async (req, res) => {
    try {
        ...
        if (!firstname || !lastname || !email || !phoneNumber || !password || !reconfirmPassword || !role) {
        ...
        const hashedreconfirmPassword = await bcrypt.hash(reconfirmPassword, 10);
        ...
        const newUser = await User.create({
            ...
            reconfirmPassword: hashedreconfirmPassword,
            role,
            profile: {
