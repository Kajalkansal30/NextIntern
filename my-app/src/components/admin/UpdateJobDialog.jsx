...
const UpdateJobDialog = () => {
    ...
    useGetJobById(params.id);  // This hook fetches job data based on job id from URL
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.data.success) {
                dispatch(setUser(res.data.message)); // If needed, you can update the user state in Redux
                toast.success(res.data.message);
                navigate("/admin/jobs"); // Navigate to /admin/jobs after successful update
            }
        } catch (err) {
